...
2. 任意の予約運用ファイル `docs/CONCERNS.md` が存在する場合は、確認したい主張をそこから列挙する。存在しない場合は、ユーザーの依頼と対象エンティティから確認事項を整理する。そのうえで、
...
2. エンティティ本文・型固有フィールド・relations を更新し、`sources` の参照を確認する。
